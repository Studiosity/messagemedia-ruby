...
describe Messagemedia::SOAP::Client do
  ...
  describe '#send_message' do
    it 'sends a message' do
      ...
      result = client.send_message('0491570156', 'Test', 0, source_number: '0491570110')
    ...
    context 'no delivery report' do
      it 'sends a message' do
        ...
        client = described_class.new('username', 'password')
        result = client.send_message('0491570156', 'Test', 0, delivery_report: false)
